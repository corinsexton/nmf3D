...
# Step 2 Intersect regions for different cell types
 ...
 ## ALL REGIONS
bedtools intersect -a ../../RcppML_nmf/h1_labelled_chromhmm.bed -b ../../RcppML_nmf/endo_labelled_chromhmm.bed -wao  > nmf3D_network_h1.bed
bedtools intersect -b ../../RcppML_nmf/h1_labelled_chromhmm.bed -a ../../RcppML_nmf/endo_labelled_chromhmm.bed -wao  > nmf3D_network_endo.bed
