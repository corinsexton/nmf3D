...
#awk '{print}' ../../choose_top_results/nmf3D_network_all.bed > network.bed

echo -e "H1\tEndo" > network.tsv
awk -F '\t' '{print $4+1"\t"$8+1}' ../../choose_top_results/nmf3D_network_all.bed >> network.tsv
