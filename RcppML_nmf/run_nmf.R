...
# cv_predict <- crossValidate(matCSC, k = 1:10, method = "predict", reps = 3, seed = 123)
# cv_robust <- crossValidate(matCSC, k = 1:10, method = "robust", reps = 3, seed = 123)
# cv_impute <- crossValidate(matCSC, k = 1:10, method = "impute", reps = 3, seed = 123)
# 
...
w <- pheatmap(model$w[order_rows,], scale = "row", border_color = NA, cluster_rows = F,
...
png(paste0("nmf3D_results_",num_labels,".png"),width = 2600, height = 1000, res = 200)
